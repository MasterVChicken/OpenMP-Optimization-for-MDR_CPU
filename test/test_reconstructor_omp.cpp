...
int main(int argc, char ** argv){
    ...
    string metadata_file = "refactored_data/metadata_" + to_string(k) + ".bin";
    int num_levels = 0;
    int num_dims = 0;
    {
    ...
    for(int i=0; i<num_levels; i++){
        string filename = "refactored_data/level_" + to_string(i) + "_" + to_string(k) + ".bin";
...
std::cout << "Reconstruct (parallel) time: "
